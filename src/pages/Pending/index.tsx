                ...
                <motion.div variants={containerVariants} initial="hidden" animate="visible" className="w-full max-w-4xl">
                    ...
                    <motion.div variants={itemVariants} className="mb-6">
                        <Card className="bg-white/80 shadow-xl backdrop-blur-sm border-0">
                            <CardHeader className="pb-4 text-center">
                                ...
                                <CardDescription>
                                    Thank you for choosing ACBH Bank. Our team is carefully reviewing your application to ensure the
                            ...
                            <CardContent className="space-y-6">
                                ...
                                <div className="space-y-3">
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="font-medium" style={{ color: "#1D9B5E" }}>
                                            {progress}% Complete
                                        </span>
                                    </div>
                        ...
                        <Card className="bg-white/80 shadow-lg backdrop-blur-sm border-0">
                            <CardContent className="p-4 md:p-6">
                                ...
                                <div className="space-y-3 text-slate-600 text-sm">
                                    ...
                                    <div className="flex items-start space-x-3">
                                        <div className="flex-shrink-0 bg-primary mt-2 rounded-full size-2" />
                                        <p>Upon approval, you'll gain full access to your ACBH Bank account</p>
                                    </div>
                                    <div className="flex items-start space-x-3">
                                        <div className="flex-shrink-0 bg-primary mt-2 rounded-full size-2" />
                    ...
                    <motion.div variants={itemVariants} className="mt-8 text-neutral-100 text-sm text-center">
                        ...
                        <div className="flex justify-center space-x-6">
                            <a href="mailto:support@acbhcapital.com" className="flex items-center space-x-1 hover:text-neutral-800 transition-colors">
                        ...
                        <p className="mt-4 text-xs">© {new Date().getFullYear()} ACBH Bank. All rights reserved.</p>
                    </motion.div>
                </motion.div>
            </div>
        </main>
