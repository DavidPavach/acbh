...
const Index = () => {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer:
                "If you notice any suspicious activity on your account, contact us immediately at email support@acbhcapital.com. We'll investigate and take appropriate action.",
        },
    ]
    ...
    const contactMethods = [
        {
            ...
            details: "support@acbhcapital.com",
            color: "bg-accent",
        },
        {
            icon: MessageCircle,
