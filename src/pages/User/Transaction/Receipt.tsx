    ...
    const handleShare = () => {
        if (navigator.share) {
            navigator.share({
                ...
                text: "ACBH Bank Transaction Receipt",
            ...
            <div className="mx-auto max-w-4xl">
                <motion.div variants={containerVariants} initial="hidden" animate="visible">
                    ...
                    <motion.div variants={itemVariants} className="mb-8 text-center">
                        ...
                        <p className="font-medium text-slate-600">ACBH Bank</p>
                    </motion.div>
                    {/* Main Receipt Card */}
                        ...
                        <Card className="bg-slate-50/80 shadow-lg backdrop-blur-sm border-0">
                            <CardContent className="p-6 text-center">
                                ...
                                <p className="text-slate-600">
                                    This receipt is digitally secured and verified by ACBH Bank. Keep this receipt for your
                                    records and contact us immediately if you notice any discrepancies.
                                </p>
                                <p className="mt-3 text-slate-500 text-xs">Customer Service: support@acbhcapital.com | Available 24/7</p>
                            </CardContent>
                        </Card>
                    </motion.div>
                </motion.div>
