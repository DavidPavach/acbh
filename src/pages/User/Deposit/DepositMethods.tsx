...
const depositMethods = [
  {
    ...
    limit: "No limit",
    steps: [
      "Obtain your ACBH routing and account numbers above",
      "Log into your sending bank's online portal",
      "Initiate a wire transfer using ACBH details",
  ...
  },
  {
    ...
    steps: [
      "Provide your employer with ACBH routing number",
  ...
  },
  {
    ...
    description: "Deposit checks using the ACBH mobile app",
    timing: "1-2 business days",
    fee: "Free",
    limit: "Up to $50,000/day",
    steps: [
      "Download the ACBH Mobile app",
  ...
  },
  {
    ...
    description: "Deposit cash or checks at any ACBH branch",
    timing: "Immediate",
    fee: "Free",
    limit: "No limit",
    steps: [
      "Visit any ACBH branch location in New York",
